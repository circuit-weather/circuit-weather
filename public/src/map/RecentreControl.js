...
export class RecentreControl {
    ...
    init() {
        ...
        this.button = document.createElement(isMapbox ? 'button' : 'a');
        this.button.className = isMapbox ? 'mapboxgl-ctrl-icon' : 'leaflet-control-zoom-recentre';

        // Leaflet styles as an anchor
        if (!isMapbox) {
            this.button.href = '#';
        }
