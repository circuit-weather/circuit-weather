export const it = {
  ...
  controls: {
    onlyF1Supported: "Attualmente e supportata solo la Formula 1",
    f1: "Formula 1",
    series: "Serie",
    round: "Round",
    session: "Sessione",
  ...
  forecast: {
    ...
    emptyStateAria: "Seleziona una sessione per vedere le previsioni",
  },
  weather: {
    ...
    timelineAria:
      "{{time}}. {{description}}. Temperatura {{temp}} gradi. Probabilita pioggia {{rain}}%. Vento {{wind}} {{windUnit}}.",
  ...
  radar: {
    ...
    playbackPosition: "Posizione di riproduzione radar",
    ...
    retryingFailedTiles: "Nuovo tentativo per {{count}} tile non riuscita...",
    retryingFailedTilesPlural:
      "Nuovo tentativo per {{count}} tile non riuscite...",
  ...
  meta: {
    ...
    defaultDesc:
      "Resta davanti alla pioggia con Circuit Weather. Radar meteo in tempo reale, previsioni live e countdown sessioni per ogni circuito di Formula 1 nel mondo.",
    sessionTitle: "{{raceName}} {{sessionName}} Meteo - Circuit Weather",
    raceTitle: "{{raceName}} Meteo - Circuit Weather",
    sessionDesc:
      "Radar meteo live, previsioni e countdown per {{raceName}} {{sessionName}}. Segui pioggia e condizioni in tempo reale.",
    raceDesc:
      "Radar meteo live e previsioni per {{raceName}}. Segui pioggia e condizioni durante ogni sessione del Gran Premio.",
  },
  weatherCodes: {
