export const fr = {
    "common": {
        ...
        "github": "GitHub",
        "githubTitle": "Voir le code source sur GitHub",
        "bmc": "Achetez-moi un café"
    },
    "theme": {
    ...
    "loading": {
        "schedule": "Chargement du calendrier des courses...",
    ...
    "controls": {
        ...
        "selectRoundFirst": "Selectionnez d'abord une manche",
    ...
    "forecast": {
        ...
        "availableFrom": "Previsions disponibles a partir de {{date}}",
        "availableSoon": "Previsions disponibles bientot",
        "availableCloser": "Previsions disponibles plus pres de la session",
        "unavailable": "Impossible de charger les previsions",
        "failedTryAgain": "Echec du chargement des previsions. Veuillez reessayer.",
    ...
    "weather": {
        ...
        "rain": "Pluie",
        "wind": "Vent",
        "windDirection": "Direction du vent : {{direction}} ({{degrees}} degres)",
        "timelineAria": "{{time}}. {{description}}. Temperature {{temp}} degres. Risque de pluie {{rain}}%. Vent {{wind}} {{windUnit}}.",
        "currentCircuitWeather": "Meteo actuelle du circuit",
    ...
    "radar": {
        ...
        "beforeSession": "{{duration}} avant la session",
        "afterSession": "{{duration}} apres la session",
        "forecast": "Previsions",
        "live": "En direct",
        "liveAria": "Radar en direct",
        "minutesAgo": "Il y a {{count}} min",
        "minutesAgoPlural": "Il y a {{count}} mins",
        "connectionInstability": "Connexion instable",
        "serviceError": "Erreur du service",
        "highTraffic": "Trafic eleve",
        "rateLimitExceeded": "Limite de requetes depassee. Pause momentanee.",
        "retryingFailedTiles": "Nouvelle tentative pour {{count}} tuile{{suffix}} en echec...",
        "radarStatus": "Statut radar : {{status}}"
    },
    "countdown": {
        "startsIn": "Debute dans",
        "day": "jour",
        "dayPlural": "jours",
        "hour": "heure",
        "hourPlural": "heures",
    ...
    "map": {
        "recenterOnCircuit": "Recentrer sur le circuit"
    },
    "privacy": {
    ...
    "errors": {
        ...
        "sessionLoadFailed": "Echec du chargement des previsions ou du radar de session."
    },
    "status": {
        "live": "EN DIRECT",
        "current": "Actuel",
    ...
    "races": {
        ...
        "Mexico City Grand Prix": "Grand Prix du Mexique",
        ...
        "Abu Dhabi Grand Prix": "Grand Prix d'Abou Dhabi"
    },
    "circuits": {
        "Albert Park Circuit": "Circuit de l'Albert Park",
        "Bahrain International Circuit": "Circuit international de Bahreïn",
        "Jeddah Corniche Circuit": "Circuit de la corniche de Djeddah",
        "Suzuka International Racing Course": "Circuit international de Suzuka",
        "Shanghai International Circuit": "Circuit international de Shanghai",
        "Miami International Autodrome": "Autodrome international de Miami",
        ...
        "Circuit de Barcelona-Catalunya": "Circuit de Barcelone-Catalogne",
        "Red Bull Ring": "Red Bull Ring",
        "Silverstone Circuit": "Circuit de Silverstone",
        "Hungaroring": "Hungaroring",
        "Circuit de Spa-Francorchamps": "Circuit de Spa-Francorchamps",
        "Circuit Zandvoort": "Circuit de Zandvoort",
        "Autodromo Nazionale di Monza": "Autodromo Nazionale di Monza",
        "Baku City Circuit": "Circuit urbain de Bakou",
        "Marina Bay Street Circuit": "Circuit urbain de Marina Bay",
        "Circuit of The Americas": "Circuit des Amériques",
        "Autódromo Hermanos Rodríguez": "Autódromo Hermanos Rodríguez",
        "Autódromo José Carlos Pace": "Autódromo José Carlos Pace",
        "Las Vegas Strip Circuit": "Circuit du Strip de Las Vegas",
        "Lusail International Circuit": "Circuit international de Lusail",
