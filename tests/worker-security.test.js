...
describe('Worker Security Utils', () => {
  ...
  describe('Malicious Origin Validation', () => {
    ...
    it('rejects attacker origins spoofing preview domain via trailing domain suffix', () => {
    ...
    it('rejects attacker origins spoofing preview domain via host prefix', () => {
      const attackerOrigin = 'https://evil-circuit-weather.pages.dev';
      const targetUrl = PROD_URL;
      const req = createRequest({ 'Origin': attackerOrigin });
    ...
    it('allows legitimate preview domains with subdomains and optional ports', () => {
      const validOrigins = [
        'https://circuit-weather.pages.dev',
        'https://feature-branch.circuit-weather.pages.dev',
        'https://v1.feature.circuit-weather.pages.dev',
        'https://circuit-weather.pages.dev:8443'
      ];
      const targetUrl = PROD_URL;
